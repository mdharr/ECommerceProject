...
public class Order {
    ...
    public void add(OrderItem item) {
        if (item != null) {
            System.out.println("Adding item: " + item.getProductId());
            System.out.println("Current orderItems size: " + orderItems.size());
            orderItems.add(item);
            System.out.println("New orderItems size: " + orderItems.size());
            item.setOrder(this);
        }
    }
